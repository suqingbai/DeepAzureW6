...
resourcegroup_name = 'sbaihw6rg'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'sbaihw6sa'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
print('Created entry for nissan maxima...')
...
car.price = 25000.00
table_service.insert_entity('itemstable', car)
print('Created entry for volkswagen passat...')
...
coffee.flavor = 'balanced & nutty'
coffee.size = 'small'
coffee.price = 2.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for a Starbucks coffee...\n')
time.sleep(1)
...
items = table_service.query_entities('itemstable', filter="PartitionKey eq 'cars'", select='maker,model,price')
for item in items:
    print('maker: ' + item.maker)
    print('model: ' + item.model)
    print('price: ' + str(item.price) + '\n')

items = table_service.query_entities('itemstable', filter="PartitionKey eq 'coffee'", select='brand,flavor')
for item in items:
